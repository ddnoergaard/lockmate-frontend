...
export default function AppOrgCreatePage() {
  ...
  const [form, setForm] = useState({ name: '', vatNumber: '', email: '', phone: '' })
  ...
  async function handleSubmit(e: { preventDefault(): void }) {
    e.preventDefault()
    setError('')
    if (!form.name.trim()) { setError('Organisationsnavn er påkrævet.'); return }
  ...
  return (
    <div className={styles.page}>
      <Helmet><title>Opret organisation – Lockmate</title></Helmet>

      <div className={styles.inner}>
        <div className={styles.head}>
          <Link to="/app/organisation/setup" className={styles.backLink}>
        ...
        <form className={styles.form} onSubmit={handleSubmit}>
          <div className={styles.field}>
            ...
            <div className={styles.inputWrap}>
              ...
              <input id="orgName" type="text" className={styles.input} placeholder="Acme ApS"
                autoComplete="organization" value={form.name} onChange={field('name')} />
            </div>
          </div>
          ...
          <div className={styles.field}>
            ...
            <div className={styles.inputWrap}>
              ...
              <input id="vatNumber" type="text" className={styles.input} placeholder="12345678"
          ...
          <div className={styles.field}>
            ...
            <div className={styles.inputWrap}>
              ...
              <input id="orgEmail" type="email" className={styles.input}
          ...
          <div className={styles.field}>
            ...
            <div className={styles.inputWrap}>
              ...
              <input id="orgPhone" type="tel" className={styles.input} placeholder="12345678"
                maxLength={9} value={form.phone} onChange={field('phone')} />
            </div>
            {form.phone.length > 8 && (
